...
struct CrystalQ32Op {
  ...
  CrystalQ32Op(void *, size_t, ssb::DeviceBuffers &buf, size_t chunk_cnt, ssb::Dataset &data)
...
int main() {
  ...
  { // perform computation
    ...
    t = gpuio::utils::time::timeit([&] {
      ...
      gpuio::execution::StaticPipelineExecutor<CrystalQ32Op> exec(layout, bufs, chunk_cnt, data);
      exec.run(exchange, s);
    });
    fmt::print("exec, {}\n", t);
