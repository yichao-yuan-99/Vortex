...
void Q11Kernel(int* lo_orderdate, int* lo_discount, int* lo_quantity, int* lo_extendedprice,
  ...
  BlockLoadCond<int, BLOCK_THREADS, ITEMS_PER_THREAD>(lo_discount + tile_offset, discount, selection_flags, num_tile_items);
  BlockPredAndGTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(discount, 1, selection_flags, num_tile_items);
  BlockPredAndLTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(discount, 3, selection_flags, num_tile_items);

  BlockLoadCond<int, BLOCK_THREADS, ITEMS_PER_THREAD>(lo_quantity + tile_offset, items, selection_flags, num_tile_items);
  BlockPredAndLT<int, BLOCK_THREADS, ITEMS_PER_THREAD>(items, 25, selection_flags, num_tile_items);

  BlockLoadCond<int, BLOCK_THREADS, ITEMS_PER_THREAD>(lo_extendedprice + tile_offset, items2, selection_flags, num_tile_items);
...
void Q12Kernel(int* lo_orderdate, int* lo_discount, int* lo_quantity, int* lo_extendedprice,
  ...
  BlockLoadCond<int, BLOCK_THREADS, ITEMS_PER_THREAD>(lo_discount + tile_offset, discount, selection_flags, num_tile_items);
  BlockPredAndGTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(discount, 4, selection_flags, num_tile_items);
  BlockPredAndLTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(discount, 6, selection_flags, num_tile_items);
...
void Q13Kernel(int* lo_orderdate, int* lo_discount, int* lo_quantity, int* lo_extendedprice,
  ...
  BlockLoadCond<int, BLOCK_THREADS, ITEMS_PER_THREAD>(lo_discount + tile_offset, discount, selection_flags, num_tile_items);
  BlockPredAndGTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(discount, 5, selection_flags, num_tile_items);
  BlockPredAndLTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(discount, 7, selection_flags, num_tile_items);
